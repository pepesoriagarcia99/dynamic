...
<style>
  ...
  .main-table::part(expansion-container) {
    max-height: 300px;
  }

  .main-table::part(column-value-0) {
    width: 40px;
    height: auto;
  }

  .main-table::part(column-value-1) {
    font-weight: 700;
  }

  .main-table::part(column-value-2) {
    font-weight: 700;
  }
  ...
  .secondary-table::part(table-container) {
